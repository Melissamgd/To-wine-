 ...
 * Contenu complet pour 6 articles (Idéal pour le carrousel)
 */
...
const knowledgeBase = [
    ...
    },
    {
        ...
        content: `
            ...
            <p style="background:#f4f4f4; padding:10px; border-left:4px solid #d4af37;"><b>💡 Conseil d'expert :</b> Visez les coopératives pour un rapport qualité/prix imbattable !</p>
        `,
    ...
    },
    {
        ...
        content: `
            ...
            <p><b>Larmes :</b> Les traces sur le verre indiquant le taux d'alcool.</p>
            <h2 style="color:#4a0404;">👃🏼 L'Examen Olfactif</h2>
            <p><b>Arômes Primaires :</b> Odeurs issues du raisin (fruit, fleur).</p>
            <h2 style="color:#4a040